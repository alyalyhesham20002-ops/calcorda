  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          <h3 className="text-lg font-semibold text-gray-900">Your Fertile Window</h3>
          {result ? (
            <div className="bg-pink-50 border border-pink-200 rounded-lg p-6 space-y-4">
              <div>
                <div className="text-sm font-medium text-pink-800">Estimated Ovulation Date</div>
                <div className="text-2xl font-bold text-pink-900">{result.ovulationDate}</div>
              </div>
              <div>
                <div className="text-sm font-medium text-pink-800">Most Fertile Days</div>
                <div className="text-xl font-bold text-pink-900">{result.fertileWindowStart} - {result.fertileWindowEnd}</div>
              </div>
              <p className="text-xs text-pink-700">Intercourse during this window gives you the highest chance of conception.</p>
            </div>
          ) : (
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 text-center"><p className="text-gray-500">Enter your info to find your fertile days.</p></div>
          )}
        </div>
      </div>
    </div>
